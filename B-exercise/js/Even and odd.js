...
Button.addEventListener("click", function () {
  ...
  // in base alla scelta del utente scelgo quale percorso seguire
  if (EvenorOdd === "Pari") {
    let FinalResult = Even(ResultNumber);
    console.log(FinalResult);
    document.getElementById("result").innerHTML = `Il tuo numero ${UserNumber}
        il Numero del pc ${PcNumber}
        il Risultato ${ResultNumber}
         il Risultato finale ${FinalResult}`;
  } else {
